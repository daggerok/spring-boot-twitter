= spring-boot-twitter image:https://travis-ci.org/daggerok/spring-boot-twitter.svg?branch=twitter-api-gateway["Build Status", link="https://travis-ci.org/daggerok/spring-boot-twitter"]
